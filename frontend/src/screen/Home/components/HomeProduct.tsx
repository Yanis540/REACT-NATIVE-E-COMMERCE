...
interface HomeProductProps extends HomeProps{
    product: Product
};
...
function HomeProduct({product,navigation}:HomeProductProps) {
    ...
    <TouchableOpacity onPress={()=>navigation.navigate("ProductDetailsScreen",{productId: product.id})} >
        <View className="flex flex-col py-4 px-2 mr-1 max-w-[250px] drop-shadow-lg border-[1px] border-gray-200 rounded-lg">
            {/* Image */}
